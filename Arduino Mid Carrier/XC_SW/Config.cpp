...
const float VOffset_V = 5.0f;
const float VScale_C = 1000.0f;   // amps per volt (arbitrary until calibrated)
const float VOffset_C = 7.0f;
...
const float PID_TO_DUTY_SCALE  = 0.00125f;    // PID unit to duty scaling factor
